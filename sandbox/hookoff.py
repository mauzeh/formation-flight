...
def get_costs_fuel(a, b, alpha, beta):
    pass

def get_costs_duration(a, b, alpha):
    pass

def run():
    
    print get_costs(1000, 100, 15, .15)
...
#def run():
    ...
    #(a, b) = project_segment(theta, origin_to_destination.get_length())
    #print get_hookoff_quotient(a, b, .25)
    #
