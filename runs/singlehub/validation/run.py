...
def execute():
    ...
    for hub in config.hubs:
        ...
        planes = [
            ...
            Aircraft('FLT002', Route([Waypoint('LHR'), Waypoint('IAD')]), 0),
            Aircraft('FLT003', Route([Waypoint('LHR'), Waypoint('IAD')]), 0),
            Aircraft('FLT004', Route([Waypoint('LHR'), Waypoint('IAD')]), 0),
            Aircraft('FLT005', Route([Waypoint('LHR'), Waypoint('IAD')]), 0),
        ]
